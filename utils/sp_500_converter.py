...
<div class="legend">
    ...
    <p>Historical data (6MB) from <a href="https://github.com/hanshof/sp500_constituents" target="_blank">this repository</a>. 
    Assume nothing.</p>
    <p>Rehashed data version (35kB) available <a href="https://backboard.uk/sp500_data.csv" target="_blank">here</a>.</p>
</div>
...
function renderGrid() {{
    ...
    data.forEach(function(d) {{
        // Instead of adjusting opacity, we use RGBA background
...
print("HTML visualization updated to keep ticker text fully opaque on hover.")